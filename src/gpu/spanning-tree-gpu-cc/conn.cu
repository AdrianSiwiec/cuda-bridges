...
__global__ 
void select_winner_init(int* an,edge *ed_list,int num_e,int num_n,int*flag,char*mark, int * ISSPAN){
    int a,b,x,y,mx;
    // int mn;
    long long int t;
...
__global__ 
void select_winner2(int* an,edge *ed_list,int num_e,int num_n,int*flag,char*mark, int * ISSPAN){
...
__global__
void select_tree_edges_and_merge2(int* an,edge *ed_list,int num_e,int num_n,int*flag,char*mark, int * ISSPAN){
    int a,b,x,y,a_x,a_y,mn,mx;
    long long int t;
    a=blockIdx.y*gridDim.x+blockIdx.x;		
    b=threadIdx.x;
 ...
 */   
__global__ 
void select_winner(int* an,edge *ed_list,int num_e,int num_n,int*flag,char*mark, int * ISSPAN){
    int a,b,x,y,a_x,a_y,mn,mx;
    long long int t;
    a=blockIdx.y*gridDim.x+blockIdx.x;
    b=threadIdx.x;
...
__global__
void select_tree_edges_and_merge(int* an,edge *ed_list,int num_e,int num_n,int*flag,char*mark, int * ISSPAN){
    int a,b,x,y,a_x,a_y,mn,mx;
    long long int t;
    a=blockIdx.y*gridDim.x+blockIdx.x;		
    b=threadIdx.x;
